; ==============================================================================
; RUTA: ./comandos/tools/math/max/max.asm
...
section .data
    msg_ayuda_1 db "Uso: max A B", 10, 0
    msg_ayuda_2 db "Descripcion: Devuelve el mayor de dos enteros con signo.", 10, 10, 0
    ...
    msg_ayuda_C db "  ./bin/max 3 7        ; resultado: 7", 10, 0
    msg_ayuda_D db "  ./bin/max -5 2       ; resultado: 2", 10, 0
    msg_ayuda_E db "  ./bin/max 0xFF 0b10  ; resultado: 255", 10, 0
