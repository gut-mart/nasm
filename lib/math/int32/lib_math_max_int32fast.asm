; ==============================================================================
; RUTA: ./lib/math/int32/lib_math_max_int32fast.asm
; DESCRIPCIÓN: Capa 2 (Motor). Devuelve el mayor de dos enteros con signo de 32 bits.
...
section .text
    global lib_math_max_int32fast

lib_math_max_int32fast:
