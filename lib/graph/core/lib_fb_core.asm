...
section .text
    ...
    global fb_core
    global fb_map          ; Exportamos la nueva funcion
...
fb_core:
    ...
    mov eax, dword [fb_fix_info + 48]  ; line_length (pitch)
    mov dword [r12 + ScreenInfo.pitch], eax
    mov eax, dword [fb_fix_info + 24]  ; smem_len
    ...
    mov eax, dword [fb_var_info + 32]  ; red_offset
    mov dword [r12 + ScreenInfo.red_off], eax
    mov eax, dword [fb_var_info + 44]  ; green_offset
    mov dword [r12 + ScreenInfo.green_off], eax
    mov eax, dword [fb_var_info + 56]  ; blue_offset
    mov dword [r12 + ScreenInfo.blue_off], eax
    mov eax, dword [fb_var_info + 68]  ; transp_offset
