...
# 📘 Documentación: Conversión Numérica (`lib_uint32_string`)

**Archivo:** `lib/cnv/lib_uint32_string.asm`
...
1. Asegúrate de que el archivo `lib_uint32_string.asm` está en tu ruta de librerías.
...
```bash
# Compilar librería
nasm -f elf64 lib/cnv/lib_uint32_string.asm -o lib_cnv.o
